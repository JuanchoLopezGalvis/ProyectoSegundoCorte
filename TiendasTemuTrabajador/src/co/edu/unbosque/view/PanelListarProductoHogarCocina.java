...
public class PanelListarProductoHogarCocina extends JPanel{
    ...
    /**
	 * Constructor de la clase {@link PanelListarProductoHogarCocina}
	 * donde se inicializan los atributos de la clase.
	 */
    public PanelListarProductoHogarCocina() {
        ...
        tablaDeProductos.setModel(new DefaultTableModel(
            new Object[][]{},
            new String[]{"Nombre", "Precio", "Cantidad", "Marca", "Material", "Color", "Función", "Imagen"}
        ) {
            /**

...
/**
 * Esta clase extiende de JPanel y se encarga de listar los productos de la categoria Oficina de Electrodomestico.
 */
public class PanelListarProductoOficinaElectrodomestico extends JPanel{
    ...
    /**
	 * Constructor de la clase {@link PanelEliminarProductoOficinaElectrodomestico}
	 * donde se inicializan los atributos de la clase.
	 */
    public PanelListarProductoOficinaElectrodomestico() {
        ...
        tablaDeProductos.setModel(new DefaultTableModel(
            new Object[][]{},
            new String[]{"Nombre", "Precio", "Cantidad", "Marca", "NIvel de calidad", "Edad recomendada", "Imagen"}
        ) {
            /**

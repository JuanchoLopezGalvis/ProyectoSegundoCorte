...
/**
 * Esta clase extiende de JPanel y se encarga de listar los productos de la categoria Oficina de Papeleria.
 */
public class PanelListarProductoOficinaPapeleria extends JPanel{
    ...
    /**
	 * Constructor de la clase {@link PanelEliminarProductoOficinaPapeleria}
	 * donde se inicializan los atributos de la clase.
	 */
    public PanelListarProductoOficinaPapeleria() {

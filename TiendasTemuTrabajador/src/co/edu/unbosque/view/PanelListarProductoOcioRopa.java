...
public class PanelListarProductoOcioRopa extends JPanel{
	 ...
	 */
    public PanelListarProductoOcioRopa() {
        ...
        tablaDeProductos.setModel(new DefaultTableModel(
            new Object[][]{},
            new String[]{"Nombre", "Precio", "Cantidad", "Marca", "NIvel de calidad", "Talla", "Imagen"}
        ) {
            /**
